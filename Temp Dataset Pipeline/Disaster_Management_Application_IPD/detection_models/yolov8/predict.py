...
def parse_args():
    parser = argparse.ArgumentParser(description="Predict with YOLOv8 on an image or directory")
...
def main():
    ...
    print(f"\n--- Running YOLOv8 Prediction on {args.source} ---")
    
    model = YOLO(args.weights)
    
    project_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "outputs", "yolov8_predict")
