...
def parse_args():
    parser = argparse.ArgumentParser(description="Train YOLO11 on complex images")
...
def train_model(model_weights, dataset_name, args, project_dir):
    ...
    print(f"\\n--- Training YOLO11 on {dataset_name} ---")
...
def main():
    args = parse_args()
    project_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "outputs", "yolo11")
